...
#### Dataset
We will be using a dataset containing 200 different classes of birds adapted from the [classifysketch dataset](https://cybertron.cg.tu-berlin.de/eitz/projects/classifysketch/).
...
New Sketch dataset and code adaptation done by Ricardo Garcia: https://github.com/rjgpinel
